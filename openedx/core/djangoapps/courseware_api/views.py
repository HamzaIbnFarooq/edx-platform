...
class CoursewareMeta:
    ...
    def related_programs(self):
        ...
        progress_by_program = {
            progress.get("uuid"): progress for progress in related_progress
        }

        programs = [{
            "progress": progress_by_program.get(program.get("uuid")),
...
class CoursewareInformation(RetrieveAPIView):
    ...
    **Response Values**
        ...
        * related_programs: A list of objects that contains related program data including:
